...
- 9f66d1a: Fix declaration builds in clean installations by explicitly loading the Nuxt schema augmentation target.
- Updated dependencies [f5d4355]
...
- Updated dependencies [b8c954e]
  - @lorion-org/runtime-config-node@1.0.0-beta.9
